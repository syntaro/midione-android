...
public class MXMidiStatic {
    ...
    public static final int[] gmResetSystem = {0xf0, 0x7e, 0x7f, 0x09, 0x01, 0xf7};
    public static final int[] gm2ResetSystem = {0xf0, 0x7e, 0x7f, 0x09, 0x03, 0xf7};
    public static final int[] gsReset = {0xF0, 0x41, -1, 0x42, 0x12, 0x40, 0x00, 0x7F, 0x00, 0x41, 0xF7};//20
    public static final int[] xgReset = {0xF0, 0x43, -1, 0x4C, 0x00, 0x00, 0x7E, 0x00, 0xF7};//10
    public static final int[] masterVolume = {0xF0, 0x7f, 0x7F, 0x04, 0x01, 0x11, MXMidiStatic.CCXML_VL, 0xF7};
    public static byte[] getBytes(int[] data, int param) {
    ...
    public static OneMessage getGMReset() {
        return OneMessage.thisBuffer(0, getBytes(MXMidiStatic.gmResetSystem, 0));
    }
    public static OneMessage getGM2Reset() {
        return OneMessage.thisBuffer(0, getBytes(MXMidiStatic.gmResetSystem, 0));
    }

    public static OneMessage getXGReset() {
        return OneMessage.thisBuffer(0, getBytes(MXMidiStatic.xgReset, 0x10)); //MU80
    }
    public static OneMessage getGSReset() {
        return OneMessage.thisBuffer(0, getBytes(MXMidiStatic.gsReset, 0x20));
    }

    public static boolean isReset(byte[] data) {
        if (checkReset(gmResetSystem, data)) {
            return true;
        }
        if (checkReset(gm2ResetSystem, data)) {
            return true;
        }
    ...
    public static final String nameOfControlChange(int data1cc) {
        ...
        return "@CC " + OneHelper.toHexString2(data1cc) + "h";
    }
